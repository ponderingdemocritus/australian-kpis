...
use crate::{
    ...
    routes::{
        __path_health, __path_livez, __path_openapi, __path_readyz, DependencyHealth,
        HealthDependencies, HealthResponse, RuntimeHealthResponse,
    },
    scorecards::{
        __path_aps_config, __path_aps_history, __path_aps_latest, __path_aps_snapshot,
        ScorecardConfigQuery, ScorecardHistoryQuery, ScorecardLatestQuery,
    },
...
#[openapi(
    ...
    components(schemas(
        ...
        au_kpis_scorecard::CoverageThresholds,
        ...
        au_kpis_scorecard::ApsSnapshotSummary,
        au_kpis_scorecard::PublishedApsSnapshot,
        au_kpis_scorecard::PublicationState,
        au_kpis_scorecard::HistoryView,
        au_kpis_scorecard::SubIndexScore,
        au_kpis_scorecard::Trend,
        au_kpis_scorecard::ZoneThresholds,
