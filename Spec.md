...
- **v0.1.4 (2026-06-22)** — Added the Derived scorecards section defining APS v1 endpoints, response contracts, scoring semantics, source coverage, cache behavior, and required tests.
